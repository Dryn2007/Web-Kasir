<x-app-layout>
    @if (config('features.user_management.enabled'))
        @if (config('features.user_management.view_list'))
            <x-slot name="header">
                                ...
                                <table class="w-full text-left border-collapse">
                                    <thead>
                                        <tr
                                            ...
                                            @if (config('features.user_management.view_history') || config('features.user_management.delete_user'))
                                            ...
                                            <tr
                                                ...
                                                @if (config('features.user_management.view_history') || config('features.user_management.delete_user'))
                                                    <td class="px-6 py-4 text-right flex justify-end gap-2">
                                                        ...
                                                        @if (config('features.user_management.view_history'))
                                                        ...
                                                        @if (config('features.user_management.delete_user'))
        ...
        @else
            <div class="py-16 bg-gray-50 dark:bg-[#0b0c15] min-h-screen flex items-center justify-center">
                <div class="text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-8">Viewing user list is currently disabled.</p>
                    <a href="{{ route('admin.dashboard') }}"
    ...
    @else
        <div class="py-16 bg-gray-50 dark:bg-[#0b0c15] min-h-screen flex items-center justify-center">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">Access Denied</h1>
                <p class="text-gray-500 dark:text-gray-400 mb-8">User management is currently disabled.</p>
                <a href="{{ route('admin.dashboard') }}"
                    class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded transition">
                    Back to Dashboard
                </a>
