        ...
        <div class="py-12 bg-gray-50 dark:bg-[#0b0c15] min-h-screen transition-colors duration-300">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    @if (config('features.category_management.create'))
                    ...
                    <div
                        class="{{ config('features.category_management.create') ? 'col-span-1 md:col-span-2' : 'col-span-1 md:col-span-3' }}">
                        <div
                            ...
                            <table class="w-full text-left text-sm text-gray-600 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        @if (config('features.category_management.show_count'))
                                            <th class="px-6 py-3 text-center">Total Products</th>
                                        @endif
                                        @if (config('features.category_management.delete'))
    ...
    @else
        <div class="py-16 bg-gray-50 dark:bg-[#0b0c15] min-h-screen flex items-center justify-center">
            <div class="text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-8">Category management is currently disabled.</p>
                <a href="{{ route('admin.dashboard') }}"
