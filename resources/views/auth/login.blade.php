<x-guest-layout>
    @if (config('features.auth.enabled') && config('features.auth.login'))
    ...
    @else
        <div class="text-center py-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Login Disabled</h2>
            <p class="text-gray-500 dark:text-gray-400 mb-6">Login is currently disabled.</p>
            <a href="{{ route('home') }}"
