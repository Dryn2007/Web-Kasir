...
<body class="font-sans antialiased bg-gray-100 dark:bg-[#0b0c15] text-gray-300">
    ...
    @auth
        @if(Auth::user()->role !== 'admin')
            @if (config('features.live_chat.enabled'))
                <div x-data="{ 
                                                        chatOpen: false, 
                                                        message: '', 
                                                        messages: [],
                                                        unreadCount: 0, 
                                                        init() {
                                                            @if (config('features.live_chat.realtime_polling'))
                                                                setInterval(() => {
                    ...
                    @if (config('features.live_chat.floating_widget'))
                        ...
                        <button @click="toggleChat()"
                            ...
                            @if (config('features.live_chat.notification_badge'))
